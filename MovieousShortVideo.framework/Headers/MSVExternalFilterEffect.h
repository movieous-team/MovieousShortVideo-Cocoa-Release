 ...
 * @return 处理完成的帧数据。
 */
- (CVPixelBufferRef)externalFilterEffect:(MSVExternalFilterEffect *)externalFilterEffect renderContext:(MSVRenderContext *)renderContext shouldProcessPixelBuffer:(CVPixelBufferRef)pixelBuffer time:(MovieousTime)time;
