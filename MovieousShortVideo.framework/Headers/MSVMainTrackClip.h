 ...
 */
@interface MSVMainTrackClip : NSObject
<
NSCopying
>
...
// The following parameters are only valid for the main track clip of the MSVMainTrackClipTypeAV type
...
// The following parameters are only valid for the main track clip of the MSVMainTrackClipTypeImage type
...
/**
 * @brief The duration of the main track clip in the main track, the duration parameter and speed affect each other, the specific operational relationship is： speed = timeRange.duration / durationAtMainTrack
...
/**
 * @brief Initialize a main track clip
 * @param type Type of main track clip
 * @param URL The file path of the main track clip supports local files only
 * @param outError If an error occurs, return the error that occurred
...
/**
 * @brief Initialize a main track clip of an audio and video type using AVAsset
 * @param asset AVAsset object used to create the main track clip
 * @param outError If an error occurs, return the error that occurred
 * @return If the initialization is successful, the completed object is returned, otherwise returns nil
 */
...
/**
 * @brief Initialize a main track clip of a image type using UIImage
 * @param image UIImage object used to create the main track clip
...
/**
 * @brief Verify that the main track clip is valid or not
 * @param outError If an error occurs, return the error that occurred
