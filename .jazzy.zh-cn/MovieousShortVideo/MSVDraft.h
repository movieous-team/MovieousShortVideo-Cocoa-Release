...
/**
 * The main track clip collection, the main track clip is arranged in the order of the duration specified by its durationAtMainTrack to form the main track of the video, and the length of the draft is determined by the length of the main track.
 */
...
/**
 * The mix track clip collection, the visual part of the video is generated by mixing the video in mainTrackClips and mixTrackClips according to the location of these clips.
 */
...
/**
 * Basic effects collection，so far we support MSVExternalFilterEditorEffect, MSVLUTFilterEditorEffect, MSVImageEffect, all of these effects will be used on the main track.
 */
...
/**
 * Time effects collection，so far we support MSVRepeatEditorEffect, MSVSpeedEditorEffect, all of these effects will be used on the main track and mix track clips.
 */
