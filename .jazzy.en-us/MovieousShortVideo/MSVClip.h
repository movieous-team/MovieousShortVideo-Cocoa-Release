...
/**
 * Video frame rate of the clip.
 */
@property (nonatomic, assign, readonly) float frameRate;

/**
 * Get snapshot generator object.
 *
 * @return The generated MSVSnapshotGenerator object.
 */
